                              ...
                              Column(
                                  ...
                                  children: [
                                    SnapController(
                                        ...
                                        Offset(0.75, 0.75),
                                        snapTargets: [
                                          SnapTarget(Offset(0.1, 0.1),
                                              Offset(0.1, 0.1)),
                                          SnapTarget(Offset(0.9, 0.1),
                                              Offset(0.85, 0.465)),
                                          SnapTarget(Offset(0.1, 0.9),
                                              Offset(0.1, 0.9)),
                                        ],
                                        animateSnap: true)
                                  ]),
...
Widget firstNormalBoxBuilder(BuildContext context) {
  return normalBox(views[0], "Move & Snap", Colors.redAccent);
}

Widget animatedBoxBuilder(BuildContext context) {
  return normalBox(views[1], "Move & Snap", Colors.redAccent);
}

Widget dottedBoxBuilder(BuildContext context) {
  return dottedBox(views[2], "Move & Snap", Colors.redAccent);
}

Widget translatedBoxBuilder(BuildContext context) {
  return translatedBox(views[3], "Move & Snap", Colors.redAccent);
}

Widget smallBoxBuilder(BuildContext context) {
  return smallBox(views[4], "*", Colors.redAccent);
}

Widget secondNormalBoxBuilder(BuildContext context) {
  return normalBox(views[5], "Move & Snap", Colors.redAccent);
}
